			...
			<div class="col-md-3">
				<div id="logo">
					<a href="{{ route('site.index') }}" class="logo-dark">
						...
						<span class="logo-text">Laravel Base Logo</span>
					</a>
					<a href="{{ route('site.index') }}" class="logo-light">
						<img src="{{ asset('assets/img/logo.png') }}" alt="logo">
						<span class="logo-text">Laravel Base Logo</span>
					</a>
					<a href="{{ route('site.index') }}" class="logo-dark-m">
						<img src="{{ asset('assets/img/logo.png') }}" alt="logo">
						<span class="logo-text">Laravel Base Logo</span>
					</a>
					<a href="{{ route('site.index') }}" class="logo-light-m">
						<img src="{{ asset('assets/img/logo.png') }}" alt="logo">
						<span class="logo-text">Laravel Base Logo</span>
					</a>
					...
					<div class="tt-menu-tools">
						<ul>
							...
							<!-- <li class="tt-dropdown-wrap tt-dropdown-master tt-dropdown-dark tt-dropdown-right tt-tools-lang">
								<a href="#0"><img src="{{ asset('assets/img/flags/gb.png') }}" alt="English"> EN</a>
								<ul class="tt-dropdown">
									<li><a href="" title="English"><img src="{{ asset('assets/img/flags/gb.png') }}" alt="English"> EN</a></li>
									<li><a href="" title="French"><img src="{{ asset('assets/img/flags/fr.png') }}" alt="French"> FR</a></li>
									<li><a href="" title="Deutsch"><img src="{{ asset('assets/img/flags/de.png') }}" alt="Deutsch"> DE</a></li>
								</ul>
							</li> -->
							<li>
								@if(auth()->user() == null)
								<a href="{{ url('/login') }}" class="tt-tools-button"> Login</a>
								@else
								<a class="tt-tools-button" href="{{ url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
									Logout
								</a>
